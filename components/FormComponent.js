...
const FormComponent = () => {
  ...
  const getImageUrl = (option) => `https://placeimg.com/100/100/${option.toLowerCase().replace(/\s/g, '-')}`;
          ...
          <div className="mb-4 text-center">
            ...
            <div className="flex flex-col items-center">
              {options[currentQuestionIndex] ? (
                ...
                <p className="text-red-500">Options for this question are not available.</p>
              )}
            </div>
          </div>
